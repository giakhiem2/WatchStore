...
if (isset($_GET['partnerCode'])) {
	...
	$inset_momo = " insert into tbl_momo(partner_Code,order_Id,amount,order_Info,order_Type,trans_Id,pay_Type,id_or) values ('" . $partnerCode . "','" . $orderId . "','" . $amount . "','" . $orderInfo . "'
				...
				<div class="row">
					<div class="col-sm-10 offset-sm-1 text-center">
						...
						<p>
							...
							<a href="product.php" class="btn btn-primary btn-outline-primary"><i class="icon-shopping-cart"></i> Continue Shopping</a>
						</p>
					</div>
				</div>
			</div>
