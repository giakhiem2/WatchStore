...
if (isset($_SESSION['admin_logged_in'])) {
    $id_admin = $_SESSION['admin_logged_in']['admin_id'];
    $info = executeSingleResult("SELECT * FROM admin WHERE admin_id  = $id_admin");
    $role = $info['role'];
    if ($role == 1) {
        $name = "Host";
    } else {
            ...
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown"><i data-feather="bell"></i><span class="badge badge-pill badge-primary pull-right notification-badge">3</span><span class="dot"></span>
                    <ul class="notification-dropdown custom-scrollbar onhover-show-div p-0">
                        ...
                        <li class="bg-light txt-dark"><a href="javascript:void(0)" data-original-title="" title="">All
                            </a> notification</li>
                    </ul>
                </li>
