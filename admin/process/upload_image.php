...
function validateUploadFile($file,$uploadPath){
    ...
    $fileType = substr($file['pro_paramater'],strrpos($file['pro_paramater'],".") + 1);
    ...
    $num = 1;
    $fileName = substr($file['pro_paramater'],0,strrpos($file['pro_paramater'],"."));
    while(file_exists($uploadPath.'/'.$fileName.".".$fileType)){
        $fileName = $fileName . "(" .$num. ")";
        $num++;
    }
    $file['pro_paramater'] = $fileName.'.'.$fileType;
    return $file;
}
