...
if (isset($_GET['category_id'])) {
    ...
    $categorys = executeSingleResult($sql);
    $image = $categorys['image'];
    $category_name = $categorys['category_name'];
    $created_at = $categorys['created_at'];
    $edited_at = $categorys['edited_at'];
    $deleted_at = $categorys['deleted_at'];
}
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="page-body-wrapper">
            ...
            <div class="page-body">
                <form action="process/category-edit-process.php" method="post" 
                                        enctype="multipart/form-data">
                    <input type="text" value="<?php echo $category_id ?>" name="category_id" hidden>
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime" class="form-control" name="created_at"  value="<?php echo $created_at?>">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Edited at</label>
                        <input type="datetime" class="form-control" name="edited_at" value="<?php echo $edited_at?>">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Deleted at</label>
                        <input type="datetime" class="form-control" name="deleted_at"  value="<?php echo $deleted_at?>">
                    </div>
